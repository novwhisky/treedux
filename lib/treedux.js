...
function selectorFromKeyPath(keyPath) {
  if (Array.isArray(keyPath)) {
    ...
    var selector = function selector(state) {
      // console.log('sliceSelector', key, state);
      return state[key];
    };
  ...
  return function wrapComponent(ReactComponent) {
    ...
    function selectorFactory(dispatch, options) {
      ...
      return function (nextState, nextOwnProps) {
        ...
        var sliceSelector = (0, _util.selectorFromKeyPath)(options.keyPath);
        var nextSlice = sliceSelector(nextState);
    ...
    var Context = function (_React$Component) {
      ...
      _createClass(Context, [{
        ...
        value: function render() {
          ...
          return (0, _react.createElement)(Connect, this.props);
        }
      }]);
...
/*
 ...
 LICENSE file in the root directory of this source tree.
*/
var f=__webpack_require__(7),p=__webpack_require__(17);__webpack_require__(1);var r=__webpack_require__(2);
