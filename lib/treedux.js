...
var _connectSlice = __webpack_require__(41);

Object.defineProperty(exports, 'connectSlice', {
  enumerable: true,
  get: function get() {
    return _connectSlice.connectSlice;
  }
});
...
exports.connectSlice = connectSlice;
...
function connectSlice(reducer) {
  ...
  return function () {
    var mapSliceToProps = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : noop;
    var mapDispatchToProps = arguments[1];
    ...
    var container = _reactRedux.connect.apply(undefined, connectArgs);
    return function (ReactComponent) {
      var Connect = container(ReactComponent);

      var ConnectSlice = function (_Connect) {
        _inherits(ConnectSlice, _Connect);

        function ConnectSlice(props, context) {
          _classCallCheck(this, ConnectSlice);

          var _this = _possibleConstructorReturn(this, (ConnectSlice.__proto__ || Object.getPrototypeOf(ConnectSlice)).call(this, props, context));

          var keyPath = props.sliceKey;
          if (_this.store.reducerMap.hasOwnProperty(keyPath)) {
            var name = Connect.displayName;
            console.error(name + ' sliceKey conflict! \'' + keyPath + '\' is already in use.');
          } else {
            _this.store.mount(keyPath, reducer);
          }
          return _this;
        }
      ...
      ConnectSlice.propTypes = {
        sliceKey: _propTypes.string.isRequired
      };
...
/*
 ...
 LICENSE file in the root directory of this source tree.
*/
var f=__webpack_require__(7),p=__webpack_require__(17);__webpack_require__(2);var r=__webpack_require__(1);
