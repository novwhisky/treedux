...
/**
 * Get deep property via keyPath
 * @param {String} keyPath The property path via dot notation
...
/**
 * Set deep property via keyPath
 * @param {String} keyPath The property path via dot notation
 * @param {Object} obj The target object
 * @param value Value to set
 * @returns {*}
 */
export function set(keyPath, obj, value) {
  const [key, ...path] = keyPath.split('.');
  const ctx = obj[key];
